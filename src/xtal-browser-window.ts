...
declare var Polymer : {[key: string] : MyCtor};
interface IProperty{
    type: Function
}

type propType<T> = T | IProperty;
interface IXtalBrowserWindow{
    linkOnly: propType<boolean>,
    sandBox: propType<string>,
    windowTop: propType<number>,
    width: propType<number>,
    collapsedText: propType<string>,
    clicked: propType<boolean>
}
