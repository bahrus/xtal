...
module xtal.elements {
    ...
    export interface IXtalXSlidGridProperties {
        height: string | polymer.IPolymerPropertyInfo,
        width: string | polymer.IPolymerPropertyInfo,
        fillContainerHeight: boolean | polymer.IPolymerPropertyInfo,
        fillContainerWidth: boolean | polymer.IPolymerPropertyInfo
        renderCount: number | polymer.IPolymerPropertyInfo,
        clickedCellIndex: number | polymer.IPolymerPropertyInfo,
        clickedRowIndex: number | polymer.IPolymerPropertyInfo,
        numberOfWidthDeltas: number | polymer.IPolymerPropertyInfo,
        numberOfOrderChanges: number | polymer.IPolymerPropertyInfo,
        isContextMenuOpen: boolean | polymer.IPolymerPropertyInfo,
        lastClickedXValue: number | polymer.IPolymerPropertyInfo,
        lastClickedYValue: number | polymer.IPolymerPropertyInfo,
        selectionModel: string | polymer.IPolymerPropertyInfo,
        basePath: string | polymer.IPolymerPropertyInfo,
        useSlickAutoToolTips: boolean | polymer.IPolymerPropertyInfo,
        useSlickCellCopyManager: boolean | polymer.IPolymerPropertyInfo,
        useSlickCheckboxSelectColumn: boolean | polymer.IPolymerPropertyInfo,
        useDataViewDataProvider: boolean | polymer.IPolymerPropertyInfo,
        useSlickPaging: boolean | polymer.IPolymerPropertyInfo,
        useSlickColumnPicker: boolean | polymer.IPolymerPropertyInfo,
        useSlickFormatters: boolean | polymer.IPolymerPropertyInfo,
        useSlickEditors: boolean | polymer.IPolymerPropertyInfo,
        useTreeGridHelper: boolean | polymer.IPolymerPropertyInfo,
        gridRenderParams: object | polymer.IPolymerPropertyInfo,
        readyFnInitialized: boolean | polymer.IPolymerPropertyInfo,
    }
